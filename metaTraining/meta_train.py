...
#         "dhg_clean/train_data.npy",
#         "dhg_clean/train_labels.npy",
#         n_way=N_WAY,
#         k_shot=K_SHOT,
#         k_query=K_QUERY
#     )
...
#     model = DDNet()  # dummy output size
#     # model.fc2 = torch.nn.Identity()  # remove classifier
#     model = model.to(DEVICE)

#     model.load_state_dict(
#         torch.load("weights/ddnet_pretrained.pth"),
#         strict=False
#     )
...
#     torch.save(model.state_dict(), "weights/meta_model.pth")
...
#         "dhg_clean/val_data.npy",
#         "dhg_clean/val_labels.npy",
#         n_way=N_WAY, k_shot=K_SHOT, k_query=K_QUERY
#     )
#     val_loader = DataLoader(val_dataset, batch_size=1, shuffle=True)

#     # 3. Load Model (No fc2 identity hacking needed!)
...
#         # =========================
#         # Run exactly every 75 episodes (and strictly greater than 0)
    ...
    for current_seed in range(10):
        ...
        for episode, batch in enumerate(train_loader):
            ...
            if episode > 0 and episode % 75 == 0:
                ...
                if avg_val_acc > best_val_acc:
                    best_val_acc = avg_val_acc
                    torch.save(model.state_dict(), f"weights/meta_model_seed_{current_seed}.pth")
